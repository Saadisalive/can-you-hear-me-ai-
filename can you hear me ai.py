...
def compare(stats1, stats2):
    ...
    if stats1["duration"] > stats2["duration"]:
            ...
            diff = diff = ((stats2["duration"] - stats1["duration"]) / stats1["duration"]) * 100
...
def main():
    ...
    input("\nPress Enter to start second recording...")

    audio2, _, _ = record_audio("Recording 2: Speak louder or faster")
